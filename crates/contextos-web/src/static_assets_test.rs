...
#[tokio::test]
async fn serves_a_file_that_exists_under_the_static_directory() -> Result<(), Box<dyn std::error::Error>> {
...
#[tokio::test]
async fn a_traversal_attempt_never_escapes_the_static_directory() -> Result<(), Box<dyn std::error::Error>> {
